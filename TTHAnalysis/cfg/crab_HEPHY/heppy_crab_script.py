...
comp.puFileData = "$CMSSW_BASE/src/CMGTools/RootTools/data/Data_Pileup_2016_July22.root"
comp.puFileMC = "$CMSSW_BASE/src/CMGTools/RootTools/data/MC_Spring16_PU25ns_V1.root"
